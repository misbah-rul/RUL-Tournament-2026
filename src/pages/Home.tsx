...
export function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section with custom stadium background */}
      <section className="relative overflow-hidden pt-20 pb-24 md:pt-32 md:pb-36 lg:pt-40 lg:pb-44 text-white bg-black">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-black/80 pointer-events-none"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#E85D1F]/15 to-transparent opacity-60 pointer-events-none"></div>
        
        <Container className="relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-6 flex justify-center">
              <span className="inline-flex items-center rounded bg-[#E85D1F] px-3 py-1 text-[10px] font-black text-white uppercase tracking-widest">
                Tournament starts August 2026
              </span>
            </div>
            <h1 className="text-4xl font-black italic tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl text-white">
              RISEUP LABS FIFA <span className="text-[#E85D1F]">2026</span>
            </h1>
            <p className="mt-6 text-lg text-zinc-300 leading-8 sm:text-xl font-medium max-w-2xl mx-auto">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/fixtures" className="inline-flex h-12 w-full sm:w-auto items-center justify-center rounded-md bg-[#E85D1F] px-8 text-xs font-bold uppercase tracking-wider text-white shadow-lg shadow-[#E85D1F]/20 transition-all hover:bg-[#E85D1F]/90">
                View Fixtures
                <ChevronRight className="ml-2 h-4 w-4" />
              </Link>
              <Link to="/standings" className="inline-flex h-12 w-full sm:w-auto items-center justify-center rounded-md border border-zinc-800 bg-zinc-900/60 hover:bg-zinc-800/80 px-8 text-xs font-bold uppercase tracking-wider text-zinc-200 shadow-sm transition-colors hover:text-white">
                Current Standings
              </Link>
            </div>
          </div>
